...
void Excersize_2_5(int solution, int answer)
{
	...
	if (solution == SHOW)
	{
		...
		printf("=================================================================\n");
		// your code here
		printf("먼저 평균속력의 값을 구하시오.\n");
		printf("관련 공식은 평균속력 입니다. x는 거리, t는 시간으로 잡았을때 = (xf - xi) / (tf - ti)입니다.\n");
	...
	if (solution == SHOW)
	{
		...
		printf("=================================================================\n");
		// your code here
		printf("먼저 평균속도의 값을 구하시오.\n");
		printf("관련 공식은 평균속도 입니다. x는 위치, t는 시간으로 잡았을때 = (xf - xi) / (tf - ti)입니다.\n");
