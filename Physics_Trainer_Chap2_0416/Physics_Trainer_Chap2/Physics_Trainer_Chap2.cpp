...
void Excersize_2_9(int solution, int answer)
{
	...
	printf("(b) 어느 전기자동차의 제로백이 %6.2lfs라면 이때 가속도는 몇 m/s^2인가?\n\n", zero_back2);
	printf("=================================================================\n\n\n\n\n");
	...
	if (solution == SHOW)
	{
		...
		printf("그러므로 공식의 풀이는 %6.2lfkm/h * 1000 / 3600s /%6.2lfs 입니다. \n", vf1,zero_back1);
		printf("=================================================================\n\n");
	}
	...
	if (answer == SHOW)
	{
		...
		printf("(%6.2lfkm/h * 1000 / 3600s / %6.2lf) 입니다.\n",vf1, zero_back1);
	...
	if (solution == SHOW)
	{
		...
		printf("1 km = 1000 m 로 x 1000 을 해주고 h = 3600s 이므로 /3600 을 해줍니다. \n");
		printf("그러므로 공식의 풀이는 %6.2lfkm/h * 1000 / 3600s /%6.2lfs 입니다. \n",vf2, zero_back2);
		printf("=================================================================\n\n");
	}
	...
	if (answer == SHOW)
	{
		...
		printf("=========================   정 답   =============================\n");
		printf("관련 공식 (vf - vi) / (tf - ti) Δx에 대입하면");
		printf("(%6.2lf * 1000 / 3600s / %6.2lfs) 입니다.\n",vf2, zero_back2);
